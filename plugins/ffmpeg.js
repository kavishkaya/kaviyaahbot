...
if (Config.WORKTYPE == 'private') {
    ...
    lusifar.LUSIFARCMD({pattern: 'ffmpeg ?(.*)', fromMe: true, desc: Lang.FF_DESC}, (async (message, match) => {
    ...
    lusifar.LUSIFARCMD({pattern: 'ffmpeg ?(.*)', fromMe: false, desc: Lang.FF_DESC}, (async (message, match) => {
