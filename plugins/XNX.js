...
KAVISHKA.LUSIFARCMD({ pattern: 'xnx ?(.*)', fromMe: tp1, dontAddCommandList:true}, async (message, match) => {
    ...
    KAVISHKA.LUSIFARCMD({ pattern: 'xvv ?(.*)', fromMe: tp2, dontAddCommandList:true, deleteCommand: false}, async (message, match) => {
