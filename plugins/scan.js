...
if (Config.WORKTYPE == 'private') {
    lusifar.LUSIFARCMD({ pattern: 'scan ?(.*)', fromMe: true, desc: Lang.SCAN}, (async (message, match) => { 
    ...
    lusifar.LUSIFARCMD({ pattern: 'scan ?(.*)', fromMe: false, desc: Lang.SCAN}, (async (message, match) => { 
