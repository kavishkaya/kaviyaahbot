...
if (Config.WORKTYPE == 'private') {
    ...
    lusifar.LUSIFARCMD({pattern: 'tblend ?(.*)', fromMe: true, desc: Lang.T_DESC}, (async (message, match) => {    
    ...
    lusifar.LUSIFARCMD({pattern: 'tblend ?(.*)', fromMe: false, desc: Lang.T_DESC}, (async (message, match) => {    
