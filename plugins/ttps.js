...
lusifar.LUSIFARCMD({pattern: 'll ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'tred ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'tblue ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'tgreen ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'tblack ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'tyellow ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'tpink ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'tpurple ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'torange ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'tbrown ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.LUSIFARCMD({pattern: 'terin ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
