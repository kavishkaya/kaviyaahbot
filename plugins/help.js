...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    lusifar.LUSIFARCMD({pattern: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    lusifar.LUSIFARCMD({pattern: 'help ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
