...
lusifar.LUSIFARCMD({pattern: 'Nstopspam', fromMe: true, dontAddCommandList: true, desc: Lang.STOP_SPAMDESC}, (async (message, match) => {
...
lusifar.LUSIFARCMD({pattern: 'Nsendspam ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.SPAM_DESC}, (async (message, match) => {
